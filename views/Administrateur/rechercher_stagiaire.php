                ...
                <div class="app-content"><nav class="navbar navbar-expand navbar-light bg-white"><button type="button" class="btn btn-sidebar" data-toggle="sidebar"><i class="icon-menu"></i></button>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-4"><h2 align="center">Rechercher Stagiaire</h2></div>
                                <div class="col-lg-4"><hr style="background-color: #0000ff"></div>                                
                            </div>
                            <form method="POST" action="http://localhost:81/Gest_etaf/compte/Gest_etaf/info/rechercher">
                                <center>
                                    <label>Saisir le matricule : </label> 
                                    <input name="sai_rechercher" type="text" required class="form-control" style="width: 50%"> 
                                    <br>
                                    <button class="btn btn-success" name="btn_rechercher">Rechercher</button>&nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-warning" name="btn_imprimer" target="_blank">Imprimer</button>
                                </center>
                            </form><br />

                            <?php
                            if (isset($sol) AND ! empty($sol)) {
                                ?>
                                ...
                                <div class="nav-tabs-responsive">
                                    ...
                                    <form class="tab-content" action="http://localhost:81/Gest_etaf/compte/Gest_etaf/info/rechercher" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="sai_cycle" class="selectpicker form-control" data-live-search="true">
                                                                ...
                                                                if (isset($sol)) {
                                                                    ?>
                                                                    <option  selected value="<?php echo $cycle; ?>"><?php echo $cycle; ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="sai_filiere" class="selectpicker form-control" data-live-search="true">
                                                                ...
                                                                if (isset($sol)) {
                                                                    ?>
                                                                    <option  selected value="<?php echo $filiere; ?>"><?php echo $filiere; ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                        ...
                                        <div id="confirmation" class="tab-pane">
                                            ...
                                            <div id="confirmation-collapse" class="collapse" data-parent="#formOrder">
                                                ...
                                                <div class="d-block d-md-flex"><button type="button" class="btn btn-outline-success d-none d-md-inline mb-3" data-form-step="#payment"><i class="icon-arrow-left font-sm"></i> &nbsp; Informations sur les parents</button>
                                                    ...
                                                    <div class="d-block d-md-inline ml-auto mb-3"><button type="submit" class="btn btn-info btn-block" name="btn_modifier">Enregistrer les modifications</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
