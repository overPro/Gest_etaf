            ...
            <div class="app-body">
                ...
                <div class="app-content"><nav class="navbar navbar-expand navbar-light bg-white"><button type="button" class="btn btn-sidebar" data-toggle="sidebar"><i class="icon-menu"></i></button>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-2"><hr style="background-color: #0000ff"></div>
                                <div class="col-lg-8"><h2 align="center">Liste Versements par Période par Produit</h2></div>
                                <div class="col-lg-2"><hr style="background-color: #0000ff"></div>                                
                            </div>
                            <form style="margin-left: 10%;" action="http://localhost:81/Gest_etaf/compte/versements/Gest_etaf/consultation_periode_produit" method="POST">
                                <div class="row">                                    
