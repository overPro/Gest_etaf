            ...
            <div class="app-body">
                ...
                <div class="app-content"><nav class="navbar navbar-expand navbar-light bg-white"><button type="button" class="btn btn-sidebar" data-toggle="sidebar"><i class="icon-menu"></i></button>
                        ...
                        <div class="container-fluid">
                            ...
                            <form enctype="multipart/form-data" action="http://localhost:81/stagiaire/compte/stagiaire/local/editProfil" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        if(!empty($photo)){
                                        ?>
                                        <img src="http://localhost:81/Gest_etaf/Fichiers/Gest_etaf/<?php echo $photo;?>" width="150"><br /><br />
                                        <?php
                                        }  else {
                                            ?>
                                        ...
                                        ?>
                                        <input type="file" class="form-control" placeholder=" im" name="sai_photo" style="width: 40%"><br />
                                    </div>
                                    <div class="col-md-4">                                        
                                    </div>
                                </div>
